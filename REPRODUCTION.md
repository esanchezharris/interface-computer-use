...
Environment: macOS arm64, Node24.16.0, npm11.13.0, Chromium153.0.8010.12. This is a clean source checkout on the same machine, not a pristine-machine or cross-platform claim. Public anonymous-checkout smoke also passed at `e7e94c0b992424dfc0e38953c76e48ded5ae0c3e`: anonymous HTTP200, clone of default `main`, `npm ci`, `npm run browser:install`, `npm run build`, and `node --import ./dist/scripts/model-bomb.js dist/src/cli/demo.js replay --require-live`, all exit0. [Run87039f72](evidence/87039f72-8d3d-417a-b21d-80ad2a4a9f89/manifest.json) records clean published source, the exact artifact hash and zero model calls. Test-side assertions verified all current UI outputs and commits0. The public clone excluded private PDF/approval/ledgers, retained README/REPORT/evidence, and remained clean. The subsequent documentation-only commit records this receipt without changing the executable candidate.
